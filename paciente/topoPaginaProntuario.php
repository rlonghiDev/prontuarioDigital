<?php 
    ...
    if($_SESSION['acesso'] == 0){
        ...
        <div class="w3-row-padding w3-margin-top" style="background-color:dimgrey; color:white; text-align:center;"><h3>
            ...
            <div class="w3-quarter"><a href= "/prontuarioDigital/paciente/anamnese.php">Anamnese</a></div>
            <div class="w3-quarter"><a href= "/prontuarioDigital/paciente/exames.php">Exames</a></div>
