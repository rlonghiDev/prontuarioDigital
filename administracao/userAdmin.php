...
<div class="w3-row-padding w3-margin-top" style="background-color:blue; color:white; text-align:center;"> 
    <div class="w3-half"><a href= "/administracao/criaUsuario.php"><h2>Novo Usuário</h2></a></div>
    <div class="w3-half"><a href= "/administracao/buscaUsuario.php"><h2>Buscar Usuário</h2></a></div>
